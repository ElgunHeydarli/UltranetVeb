        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">İstifadəçilər cədvəli</h3>
            ...
            <div class="card-body table-responsive p-0">
              ...
              <table class="table table-hover text-nowrap">
                <a href="uyeler-ekle"><button style="float:right" type="submit" class="btn btn-success">Yeni istifadəçi əlavə et</button></a>
                <thead>
                  <tr>
                    <th>İd</th>
                    <th>Email</th>
                ...
                <tbody>
                  ...
                  while ($kullanicicek=$kullanici->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      ...
                      <td><a href="islem.php?kullanicisil&id=<?php echo $kullanicicek['kullanici_id'] ?>"><button type="submit" class="btn btn-danger">Sil</button></a></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
