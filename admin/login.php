...
<div class="login-box">
  <div class="login-logo">
    <a style="color:white" href="#"><b style="color:white">Ultranet </b>az</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
        ...
        <?php
           if (@$_GET['durum']=="hata") { ?>
        <p style="color:red" class="login-box-msg">       Isdifadəci adı və ya parol səhfdir
     <?php      }
       elseif (@$_GET['durum']=="gulegule") { ?>
        <p style="color:black" class="login-box-msg">    Darıxacıyıq sənsiz(((
     <?php      }
           else{
            echo "Giriş məlumatlarınızı daxil edin.";
           }
      ...
      <form action="islem.php" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button name="girisyap" type="submit" class="btn btn-success btn-block">Daxil ol</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
